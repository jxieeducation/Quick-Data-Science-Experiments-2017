...
a = CharRNN(is_training=True, batch_size=32, num_unrollings=100, vocab_size=26, 
               hidden_size=50, max_grad_norm=5, embedding_size=64, num_layers=2,
               learning_rate=0.001, model='lstm', dropout=0.0, input_dropout=0.0, use_batch=True)
